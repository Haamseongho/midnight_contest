...
5. **Awesome dApps 추가 증빙 완료:** Lace Preview 연결, tNIGHT 수령, tDUST 등록과 양수 잔액에 이어 실제 계약 배포·claim·최종 `claimed = true` 상태를 2026-09-25 확인했다. 공개 계약 주소와 두 transaction ID는 `docs/PREVIEW_DEPLOYMENT.md`에 기록했고, 지갑 주소와 패스 비밀값은 기록하지 않았다.
