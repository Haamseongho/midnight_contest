...
> 2026-09-26 후속 정정: 아래의 ‘과거 검증 시각 없음’ 판단은 원본 재대조로 정정했다. `76d6610`/`f87aee3`의 PREVIEW_DEPLOYMENT.md에는 **2026-09-25 10:46 UTC (19:46 KST)**가 분 단위로 기록돼 있다. 이는 원본 문서의 관찰 기록이지 블록 포함 시각이 아니다. 새 후보의 U3 및 전체 검수는 [최신 통합 검증](./FINAL_INTEGRATION_VALIDATION.md)을 참조한다. 아래 당시 기록은 보존한다.
