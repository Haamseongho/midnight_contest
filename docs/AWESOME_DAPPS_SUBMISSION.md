...
This draft follows the current official [contribution guide](https://github.com/midnightntwrk/midnight-awesome-dapps/blob/main/CONTRIBUTING.md) and [pull-request template](https://github.com/midnightntwrk/midnight-awesome-dapps/blob/main/.github/PULL_REQUEST_TEMPLATE/pull_request_template.md). Re-check both immediately before submission because the upstream list can change.
...
- [x] Project CI checks have succeeded, including the production dependency audit and local-network transaction E2E ([run 35951433019](https://github.com/Haamseongho/midnight_contest/actions/runs/35951433019))
